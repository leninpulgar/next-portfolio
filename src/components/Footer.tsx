    ...
    <div>
      ...
      <div className="preview flex min-h-[350px] w-full items-center justify-center p-2 sm:p-10">
        <div className="relative w-full overflow-hidden border-t border-black bg-black px-8 py-20 dark:border-white/[0.1] dark:bg-neutral-950">
          <p className="inset-x-0 md:mt-10 bg-gradient-to-b from-neutral-950 to-neutral-800 bg-clip-text text-center font-bold text-5xl text-transparent dark:from-neutral-950 dark:to-neutral-800 md:text-9xl lg:text-[12rem] xl:text-[13rem] pb-20 md:pb-20">
            Let&apos;s Connect
          </p>
